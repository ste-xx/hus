define("fn", ["require", "exports"], function (require, exports) {
    ...
    exports.uuidv4 = exports.wtfWrap = exports.when2 = exports.when = exports.applyWhenNot = void 0;
...
define("MinMaxKi", ["require", "exports"], function (require, exports) {
    ...
    class MinMaxKi {
        constructor(player, eventDispatcher, eventBus, depth = 20) {
            this.player = player;
            this.eventBus = eventBus;
            this.eventDispatcher = eventDispatcher;
            this.depth = depth;
        ...
        static simulateMove(currentField, otherField, index) {
        ...
        findBestMove(myField, otherField) {
